/* $Id: squirrel_helper.hpp 22886 2011-09-03 18:56:34Z frosch $ */
...
namespace SQConvert {
	...
	template <> inline int Return<double>      (HSQUIRRELVM vm, double res)      { sq_pushinteger(vm, res); return 1; }
	...
	template <> inline double      GetParam(ForceType<double>      , HSQUIRRELVM vm, int index, SQAutoFreePointers *ptr) { SQFloat       tmp; sq_getfloat      (vm, index, &tmp); return tmp; }
