/* $Id: settings.h 22598 2011-06-18 18:37:10Z rubidium $ */
...
/* For the dedicated build we'll enable dates in logs by default. */
	 ...
	 SDTC_BOOL(network.pause_on_join,                    S, NO,  true,                        STR_NULL,                                       NULL),
	  ...
	  SDTC_VAR(network.server_port_var_from, SLE_UINT16, S, NO,0,0,65535,0,					  STR_NULL,                                       NULL),
	  SDTC_VAR(network.server_port_var_to,	 SLE_UINT16, S, NO,0,0,65535,0,					  STR_NULL,                                       NULL),
	 ...
	 SDTC_BOOL(network.autoclean_companies,              S, NO, false,                        STR_NULL,                                       NULL),
	  ...
	  SDTC_VAR(network.restart_iddle_months,  SLE_UINT8, S,D0|NO,  12,     0,         240, 0, STR_NULL,                                       NULL),
